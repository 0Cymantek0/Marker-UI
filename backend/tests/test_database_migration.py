...
KERNEL_TABLES = {
    ...
    "kernel_query_cursors",
    "kernel_connector_streams",
    "kernel_connector_inbox",
    "kernel_context_disclosures",
    "kernel_answer_traces",
    "kernel_answer_trace_disclosures",
    "kernel_answer_support_assessments",
}
