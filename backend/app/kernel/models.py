"""Truth Kernel persistence models (V3.2 PR63A commit spine).

Four tables establish the durable commit authority:
...
# Envelope semantics version for the PR63A commit spine as a whole.
